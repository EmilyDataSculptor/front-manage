...
import RegisterPage from '../views/pages/login/register.page.vue';
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: 'product',
            component: () => import('@/views/pages/official/product.page')
          },
          {
            path: '/official/socialResponsibility',
            name: 'socialResponsibility',
            component: () => import('@/views/pages/official/socialResponsibility.page')
          },
          {
            path: '/official/serviceAndSupport',
            name: 'serviceAndSupport',
            component: () => import('@/views/pages/official/serviceAndSupport.page')
          },
          {
            path: '/official/newsCenter',
            name: 'newsCenter',
            component: () => import('@/views/pages/official/newsCenter.page')
          },
          {
            path: '/official/industryNews',
            name: 'industryNews',
            component: () => import('@/views/pages/official/industryNews.page')
          },
          {
            path: '/official/contactUs',
            name: 'contactUs',
            component: () => import('@/views/pages/official/contactUs.page')
          },
          {
            path: '/official/contactUsOnSubmitted',
            name: 'contactUsOnSubmitted',
            component: () => import('@/views/pages/official/contactUsOnSubmitted.page')
          },
          {
            path: '/official/downloadCenter',
            name: 'downloadCenter',
            component: () => import('@/views/pages/official/downloadCenter.page')
          },
          {
            path: '/doc/readme',
            name: 'readme',
...
const routeWhiteListByOther = ['register']; 
router.beforeEach(async (to, from, next) => {
  await new Vue().__appMounted();
  // 白名单
  if (routeWhiteList.includes(to.name) || routeWhiteListByOther.includes(to.name)) return next();
  // token 不存在
