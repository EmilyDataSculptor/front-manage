        ...
        <div class="container-header">
          ...
          <div class="filter">
            ...
            <div class="filter-item">
              ...
              <el-input size="small" v-model="formInline.VagueCity" placeholder="城市"></el-input>
            </div>
            <div class="filter-item">
              <el-button size="small" type="primary" @click="selectVagueByMainTitleAndCity">查询</el-button>
            </div>
          </div>
        </div>
      ...
      :before-close="handleClose">   
          ...
          <el-form :model="form" :rules="rules" ref="formRef" label-width="110px" :label-position="labelPosition">  
            ...
            <el-form-item label="首页展示图片">  
              <img :src="updateResponse.picture" style="width: 450px; height: auto;">
            </el-form-item>  
            <el-form-item label="内容">  
              <span>{{ updateResponse.content }}</span> 
            </el-form-item>  
            <el-form-item label="城市">  
              <span>{{ updateResponse.city }}</span> 
            </el-form-item> 
          </el-form>  
        </template>  
    </el-dialog> 
    ...
    <el-dialog  
      ...
      :before-close="handleClose">   
          ...
          <el-form :model="form" :rules="rules" ref="formRef" label-width="110px" :label-position="labelPosition">  
            ...
            <el-form-item label="城市" prop="addCity">  
              <el-input v-model="form.addCity"></el-input>  
            </el-form-item> 
    ...
    <el-dialog  
      ...
      :before-close="handleClose">   
          ...
          <el-form :model="form" :rules="rules" ref="formRef" label-width="110px" :label-position="labelPosition">  
            ...
            <el-form-item label="城市">  
              <el-input v-model="updateResponse.city"></el-input>  
            </el-form-item> 
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      checkDetails(id) {
        this.selectServiceAndSupportById(id)  
      ...
      DeleteMultiple() {
        this.$confirm('此操作将永久删除数据, 是否继续?', '提示', {
          ...
          this.checkBoxData.forEach(e=>{
            this.deleteServiceAndSupport(e.id)
          }) 
          this.$message({
            type: 'success',
            message: '删除成功!'
      ...
      selectVagueByMainTitleAndCity() {  
        axios.get(this.$API_BASE_URL+'/serviceAndSupport/selectVagueByMainTitleAndCity',{
          params: {
          mainTitle:this.formInline.VagueMainTitle,
          city:this.formInline.VagueCity,
      ...
      updateServiceAndSupport() {  
        axios.post(this.$API_BASE_URL+'/serviceAndSupport/updateServiceAndSupport',{
          id:this.id,
          mainTitle:this.updateResponse.mainTitle,
          content:this.updateResponse.content,
          city:this.updateResponse.city,
      ...
      selectServiceAndSupportById(id) { 
        axios.get(this.$API_BASE_URL+`/serviceAndSupport/selectServiceAndSupportById?id=${id}`,{
        }).then(response => { 
          console.log('response.data', response.data); 
          this.id=id;
    ...
    deleteServiceAndSupport(id) { 
        axios.post(this.$API_BASE_URL+'/serviceAndSupport/deleteServiceAndSupport',{
          id:id
        }).then(response => { 
          console.log('response.data', response.data); 
          this.$router.go(0);
    ...
    deleteMessage(id) {
        this.$confirm('此操作将删除该条数据, 是否继续?', '提示', {
          ...
          this.deleteServiceAndSupport(id);
          this.$message({
            type: 'success',
            message: '删除成功！！！'
          });
    ...
    resetForm() {
      ...
      addServiceAndSupport() {  
        axios.post(this.$API_BASE_URL+'/serviceAndSupport/addServiceAndSupport',{
          mainTitle:this.form.addMainTitle,
          content:this.form.addContent,
          city:this.form.addCity,
          picture:this.form.profilePicture
        }).then(response => { 
          console.log('response.data', response.data); 
        }).catch(error => {  
    ...
    selectListByServiceAndSupport() {  
      axios.get(this.$API_BASE_URL+'/serviceAndSupport/selectListByServiceAndSupport',{
        params: {  
          currentPage: this.currentPage,  
          pageSize: this.pageSize, 
        }, 
