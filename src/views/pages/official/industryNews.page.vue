  ...
  export default {
    ...
    methods: {
      ...
      selectVagueByMainTitle() {  
        axios.get(this.$API_BASE_URL+'/industryNews/selectVagueByMainTitle',{
          params: {
      ...
      updateIndustryNews() {  
        axios.post(this.$API_BASE_URL+'/industryNews/updateIndustryNews',{
          id:this.id,
    ...
    selectListById(id) { 
        axios.get(this.$API_BASE_URL+`/industryNews/selectListById?id=${id}`,{
        }).then(response => { 
          console.log('response.data', response.data); 
          this.id=id;
    ...
    deleteIndustryNews(id) { 
        axios.post(this.$API_BASE_URL+'/industryNews/deleteIndustryNews',{
          id:id
        }).then(response => { 
          console.log('response.data', response.data); 
          this.$router.go(0);
    ...
    resetForm() {
      ...
      addIndustryNews() {  
        axios.post(this.$API_BASE_URL+'/industryNews/addIndustryNews',{
    ...
    selectListByIndustryNews() {  
      axios.get(this.$API_BASE_URL+'/industryNews/selectListByIndustryNews',{
        params: {  
          currentPage: this.currentPage,  
          pageSize: this.pageSize, 
        }, 
